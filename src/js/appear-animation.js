export default class AppearAnimation {
  constructor() {
    ...
    this.groupInterval       = 100; // Time in ms between animations for grouped animation
    this.viewport            = {};
  ...
  getNewElems() {
    Array.prototype.slice.call(this.appearElems).concat(
      Array.prototype.slice.call(document.querySelectorAll('[appear]')
    ));
  }
